    ...
    return (
        <div className="band-members columns">
            ...
            <ul className="row members">
                {band.members.map(member => <li className="three columns member" key={member.id}><div className="two columns"><Avatar user={member}/></div> <div className="ten columns">{member.username}</div></li>)}
            </ul>
            <div className="row invite">
                ...
                <ul className="row">
                    {memberSearch.map(user => (
                        ...
                        }} key={user.id}> <div className="one column"><i className="fa fa-plus" aria-hidden="true"></i></div><div className="two columns"><Avatar user={user}/></div> <div className="nine columns">{user.username}</div></li>
                    ))}
                </ul>
